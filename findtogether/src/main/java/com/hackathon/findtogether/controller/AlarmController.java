...
public class AlarmController {
    ...
    public Response getPostByComment(@RequestParam(value="alarmType") String alarmType) throws Exception{
        List<Alarm> alarms = alarmService.findAlarmsByType(alarmType);
        if (alarms == null)
